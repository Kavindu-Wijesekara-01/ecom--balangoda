    ...
    <footer className="bg-[#1F2937] text-slate-300 pt-12 border-t border-gray-700">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 mb-10 md:mb-16">
          ...
          {/* 3. Customer Service & Merchant Policies (PayHere Compliance) */}
          <div className="flex flex-col items-start text-left">
          ...
          {/* 4. Google Map & Accepted Payments */}
          <div className="flex flex-col items-start w-full">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider mb-4">Find Us</h3>
            <div className="w-full max-w-full h-32 rounded-xl overflow-hidden border border-gray-600 shadow-lg mb-4">
              <iframe
            ...
            {/* PayHere Compliance: Security badge & Payment Partner info */}
            <div className="w-full">
              <p className="text-[10px] uppercase font-black text-slate-500 tracking-wider mb-2">We Accept Secure Payments Via</p>
              <div className="flex items-center gap-3 bg-white/5 border border-gray-700/50 rounded-xl p-2.5">
                <span className="text-xs font-black text-slate-300">VISA / MasterCard / Mobile Wallets</span>
              </div>
            </div>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="pt-6 pb-8 border-t border-gray-700 flex flex-col items-center gap-4 text-xs font-bold text-slate-500">
